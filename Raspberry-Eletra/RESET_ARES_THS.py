    ...
    def set01file_ares8023(self,eqm_display_type):
        try:
            ...
            if self.reset_ares8023() :
                ...
                with open('./include/01/8023VS98.txt', 'r') as file:
                ...
                self.UART_send(b'')
                self.obj_serial.setDTR(True) 
                self.UART_read(257)
                sleep(0.3)
                self.obj_serial.setDTR(False)
